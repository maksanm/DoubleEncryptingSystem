...
namespace Encoder.Client.Services
{
    ...
    {
        private static readonly string insertMessageQueryStrung = "INSERT INTO Message (Id, EncryptedValue) VALUES (@Id, @EncryptedValue)";
        ...
        public bool InsertMessage(string id, string encryptedValue)
        {
            ...
            SqlCommand command = new SqlCommand(insertMessageQueryStrung, connection);
